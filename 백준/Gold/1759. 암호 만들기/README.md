...
### 출력 
 ...
 ### 틀린 부분
 <p> is_promising 함수로 유망한지 여부를 판단하는 과정에서 유망하지 않으면 answer 에서 값 삭제하는 코드 작성</p>
 <p> is_promising 이 false 값으로 return 되고, 호출한 부모 함수로 복귀하고, answer 에서 값 삭제 -> 같은 값을 두번 삭제하는 오류 발생 !!</p>
